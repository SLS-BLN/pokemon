...
// deconstruction - doesn't work (see below)
console.log(pokeDataTest.id);
console.log(pokeDataTest.name);
const types = pokeDataTest.types;
// [a, b] = types;
// console.log(a.type.name);
// console.log(b.type.name);

// forEach is a better choice
// each Pokemon can have a different number of types
function createList (type) {
  types.forEach((type) => {
    const typeList = type['type']['name'];
